...
CREATE TABLE `lake_lakecms_category` (
  ...
  `orders` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '排序字段字符',
...
CREATE TABLE `lake_lakecms_model` (
  ...
  `add_ip` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '添加IP',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=29 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='模型列表';
...
CREATE TABLE `lake_lakecms_model_field` (
  ...
  PRIMARY KEY (`id`),
  KEY `name` (`name`)
) ENGINE=MyISAM AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='模型字段列表';
